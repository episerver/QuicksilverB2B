<%@ Page Language="C#" AutoEventWireup="true" EnableSessionState="True" EnableViewState="true" EnableViewStateMac="true" MaintainScrollPositionOnPostback="true" CodeBehind="NewSubmission.aspx.cs" Inherits="GlobalLink.Commerce.ui.NewSubmission" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>New Submission Wizard</title>
						...
						<WizardSteps>
							<asp:WizardStep ID="ProjectSetting" runat="server" Title="Select source language">
								...
								<table width="100%" cellspacing="0" cellpadding="1">
									...
									<tr>
										...
										<th align="left" class="style8" scope="col" valign="middle">
											<asp:DropDownList ID="lstSourceLanguage" CssClass="dijitTextBox" runat="server" OnSelectedIndexChanged="sourceChanged"
												AutoPostBack="true">
											</asp:DropDownList>
										</th>
									</tr>
									<tr>
										...
										<th align="left" class="style8" scope="col" valign="middle">
											<asp:DropDownList ID="projectsList" CssClass="dijitTextBox" runat="server"  OnSelectedIndexChanged="projectChanged" >
											</asp:DropDownList>
										</th>
									</tr>
									<tr>
										...
										<th align="left" class="style8" scope="col" valign="middle">
											...
											<div class="dijitButton dijitButton3"><input type="button" class="dijitButtonNode" id="calButton" runat="server" value="..." onclick="popupCalendar()" /></div>
								...
								<table width="100%" cellspacing="0" cellpadding="0" border="0">
									...
									<tr>
										<th align="left" valign="middle" colspan="3">
											<asp:TextBox runat="server" CssClass="dijitTextBox dijitTextArea" MaxLength="254" Width="461" ID='transInstruction' Rows="3"
								...
								<table width="100%"  cellpadding="0" cellspacing="0">
									...
									<tr>
										<th align="left" valign="middle" scope="col">
											<span class="style8">
												<asp:CheckBox runat="server" ID='includeVariations' Text="Include product variations" OnCheckedChanged="includeVariations_changed" />
											</span>
										</th>
									</tr>
								</table>
									...
									<tr>
										<td valign="top" align="left">
											<asp:Repeater runat="server" ID="pagesToTranslate">
												<HeaderTemplate>
													<table width="100%" cellspacing="0" border="0" cellpadding="0" bordercolor="#ebebe6">
													...
													<tr height="22px" style="font-weight: bold; font-size: 11px; background-color: <%# GetRowColor() %>;">
														<td style="white-space: nowrap;" align="left">
															<img id="Img1" runat="server" src="Images/blank.gif" width='<%#int.Parse(Eval("indent")+"0")%>'
																height="0" />
																<asp:CheckBox ID='chkPage' CssClass='<%#Eval("pageLink") %>' runat="server" AutoPostBack="true" OnCheckedChanged="chk_pageChanged" Checked='<%# Eval("status").ToString().Equals("2") %>' />
